...
class ModelTraining:
    ...
    def load_data(self):
        try:
            ...
            logger.error(f"Error while loading the data for model {e}")
            raise CustomException("Failed to load the data for the model..")
    ...
    def  train_model(self):
        try:
            ...
            logger.info("Model trained and Saved Suceessfully...")
